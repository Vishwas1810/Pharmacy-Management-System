...
public class Sell_Info extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sale Details Done By Employee");
        ...
        jScrollPane1.setViewportView(txtSale);
    ...
    public void DisplaySale(){
        try {
            ...
            rs = pst.executeQuery();
            txtSale.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (SQLException ex) {
            Logger.getLogger(Sell_Info.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
